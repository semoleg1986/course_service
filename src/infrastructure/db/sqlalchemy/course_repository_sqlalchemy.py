        ...
        with self._session_factory() as db:
            ...
            for module_model in module_models:
                module = Module(
                    ...
                    is_required=module_model.is_required,
                    released_at=module_model.released_at,
                    status=PublishState(module_model.status),
                    meta=EntityMeta(
                ...
                for lesson_model in lesson_models:
                    lesson = Lesson(
                        ...
                        content_type=lesson_model.content_type,
                        content_ref=lesson_model.content_ref,
                        duration_minutes=lesson_model.duration_minutes,
                        is_preview=lesson_model.is_preview,
                        released_at=lesson_model.released_at,
                        status=PublishState(lesson_model.status),
                        meta=EntityMeta(
